 ...
 */
public class GenericArrayWithFT<T> implements IGenericArray<T>
{
    private T[] members;
    private int size;

    public GenericArrayWithFT(int size)
    {
        members = (T[]) new Object[size];
        this.size = 0;
    }
    ...
    private void grow()
    {
        ...
        T[] newMembers = (T[]) new Object[newArraySize];
